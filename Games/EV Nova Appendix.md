...
### Easter eggs
- Many easter eggs from EV are gone, but there's a few new ones. 
- You don't press modifier keys to "about EV" to get additional credits, just Press x at the main screen
- Less pop-culture (MST3K) references. No more cool names like Stud Beefpile, Dash Riprock, it' just Shane Merrol, Cade Connelly, etc
