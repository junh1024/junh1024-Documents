...
C-Format/UHJ https://en.wikipedia.org/wiki/Ambisonic_UHJ_format
G-Format
Pre-decoding to 5.1 media has been known as G-Format[17] during the early days of DVD audio, although the term is not in common use anymore.

https://en.wikipedia.org/wiki/Ambisonics#Multichannel_formats 
...
There are other lettered formats, but A&B are the main ambisonics formats you'll be concerned with
